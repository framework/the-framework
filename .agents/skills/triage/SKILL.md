...
2. Read every open ticket as listed, and the queue; the listing decides, open no ticket. If either read fails, show an error to the user saying which and why, and stop. Below, a ticket's `<file>` is its file name as listed, `.md` included.
