...
A ticket someone else holds is updated like any other but not closed: leave it open, for a person to close. If anything else fails once you started fetching, record no time: show an error to the user saying what failed, and stop.
