...
- **How the packages fit together** - one product package on top of six libraries it is built from, plus the scheduler, the browser skill, the command [9] packages and two companions; the product is a dashboard over what the others do.
