Documentation written for AI coding assistants — shipped with the package so an assistant working in an app that uses this SDK learns its idioms without reading the source, and generates code that matches them.
