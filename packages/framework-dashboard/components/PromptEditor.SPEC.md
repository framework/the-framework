...
- Referencing a project or file also focuses the run's context on it, and deleting the chip undoes that focus — the prompt and the context set can never silently disagree.
