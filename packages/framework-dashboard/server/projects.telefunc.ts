...
import { onProjects, sendAddProject, onOnboarding, onClaudeTrust, onAgentReady } from '@gemstack/the-framework/dashboard-rpc'

export { onProjects, sendAddProject, onOnboarding, onClaudeTrust, onAgentReady }
