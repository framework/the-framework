...
import { onProjects, sendAddProject, onOnboarding, onClaudeTrust, onAgentReady, onRepoAutoMerge } from '@gemstack/the-framework/dashboard-rpc'

export { onProjects, sendAddProject, onOnboarding, onClaudeTrust, onAgentReady, onRepoAutoMerge }
