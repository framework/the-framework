...
- **What a row shows** - the agent's one-line label, the same the sidebar shows: what the user asked for, else its scope, else its project's name; then its project's name and its age ("22s ago") with the exact moment on hover.
