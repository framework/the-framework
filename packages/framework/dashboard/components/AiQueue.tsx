...
/**
 * The prompt the play button starts an agent with: work the one entry the row shows through the
 * `queue` skill, then take it off the queue; do not start any other entry. The raw `TODO_AGENTS.md` line, not
