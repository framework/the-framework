...
- **The cross-project Overview** (`AgentOverview.tsx`, `Agents.tsx`, `OpenQuestions.tsx`, `HotTickets.tsx`, `OnboardingChecklist.tsx`, `Quota.tsx`) - what is being worked right now, every unanswered question across projects answered in place, the hottest tickets, the steps a new user still has to take, and the account's quota as one track.
