...
- **The launcher** (`StartAgentForm.tsx`) - the Start form, given the project's file list for the `#` picker; the id of a started agent is carried up to the shell so it can land on that agent.
