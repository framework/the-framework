...
- **Waiting for an answer** - an agent that ended on its question shows that it waits for an answer, not "failed"; once answered, the same agent shows "building…" again, because the leg it waited in is behind it.
