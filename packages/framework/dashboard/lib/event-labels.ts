...
// other kind falls back to its name with hyphens turned to spaces (`ready-for-merge` ->
// "ready for merge"). The badge is CSS-uppercased, so the values here stay lowercase.
