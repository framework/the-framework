...
- **A project's shared saved prompts** - read and save the saved prompts committed in the project's own `.the-framework/`, which travel with the repository for the whole team; an unknown project reads as none and refuses a save with "unknown project".
