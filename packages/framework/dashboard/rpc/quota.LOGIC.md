...
- **Setting the spend offset** - the points the user chose, sent to the daemon, which runs every project's offset hook with them; the answer is success, or an error in words the panel shows.
