1. Study what this product does today: skim the README, the docs, and the main user-facing surfaces, plus the existing tickets (`tickets list`, from the `tickets` skill)
...
3. Write each proposed feature as a new ticket with `tickets put <DATE>_<SLUG>.md`, following the ticket format the `tickets` skill gives
