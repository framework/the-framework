...
- **The cloud session window** - a web agent with no pull request reads "in cloud" while it is within 12 hours of its start, including exactly at the 12-hour mark, and "done" from one millisecond past it.
