...
[1] control file: `.the-framework/control.jsonl`: the file the daemon appends steering to (picks, chat messages, handoff moves, merge authorizations) and the agent's process tails.
...
- **Four instructions** - a pick for a parked gate, a live chat message, a move of the handoff level, and the user's Merge action.
