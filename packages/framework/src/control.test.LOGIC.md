...
- **Delivery in order** - a Merge action, a single-option pick and a multi-select pick appended to the control file reach the tailing agent in the order written, with who picked preserved.
