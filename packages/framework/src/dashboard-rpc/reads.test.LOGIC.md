...
- **An unknown project answers empty** - the checkout's files are an empty list, the file statuses an empty map, and where an agent is working nothing, never an error.
