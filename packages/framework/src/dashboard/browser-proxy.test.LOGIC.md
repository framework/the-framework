...
- **The picture reaches the bridge** - a request for the live picture arrives at the agent's browser bridge [1] and its endless-image response is passed straight back to the dashboard.
- **The input carries the click** - a click posted by the dashboard reaches the browser bridge [1] with its contents intact.
