 ...
 *
 * `auto-armed` is the preferred outcome: the git host's own auto-merge takes the PR, so it lands when
 ...
 * the git host cannot arm the merge and the PR's checks have not passed yet: merging directly there is
