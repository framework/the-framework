...
- An agent whose worktree is gone but whose archive exists follows the archived event log rather than the project root's — including when the run is filed under a person's directory on the data branch.
