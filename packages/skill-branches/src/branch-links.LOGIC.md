...
- **When it runs** - after a checkout is made, and after a checkout is named or removed through the command; nothing runs it on a clock; it never fails its caller.
