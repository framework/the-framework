 ...
 *
 * The branch itself is not named here: the runs live on the shared data branch, `agent-data`,
...
/** Where the runs live: `agents/<who>/<id>.json` and `<id>.jsonl` under the branch root. */
export const RUNS_DIR = 'agents'
