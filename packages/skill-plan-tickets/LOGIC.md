...
- **The job** (`SKILL.md`) - queueing a plan for every open ticket that has none, unattended; the routine the scheduler fires on the interval the project's schedule gives it.
