...
- **The job** (`SKILL.md`) - after work is merged, putting a maintainability refactor and a security audit of the changes that need one on the agent queue, and bringing the project's knowledge files up to date in a pull request a person merges.
