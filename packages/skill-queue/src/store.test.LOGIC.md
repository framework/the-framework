...
- **Converging with origin** - the branch reaches origin on the first sync, and an entry pushed straight onto the branch from another machine is read on the next sync.
