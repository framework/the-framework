...
The dashboard starts the run with the coding agent and the model the user picked in their preferences, when they picked them, like every start, and lands on the run. A refusal reads "The work agent could not be started.".
