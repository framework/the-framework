What the tests cover: the convention the skill names, and the pure rules tying a ticket to its siblings, to the queue and to the issue it tracks.

- **The convention** - the folder on the branch is `tickets/`.
