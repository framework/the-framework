...
- **Converging with origin** - the branch reaches origin on the first sync, and a ticket another clone pushes straight onto the branch is read on the next sync.
