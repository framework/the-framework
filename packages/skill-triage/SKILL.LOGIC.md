...
- **Skipped** - a ticket already on the queue (an entry linking to it), held by someone, in review (a pull request named on it), waiting (what it waits on named on it), or whose plan is outdated.
