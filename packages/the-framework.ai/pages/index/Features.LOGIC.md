...
- **"Bring your own subscription"** - The Framework orchestrates agents [1] through the user's own Claude Code or Codex installation, "like humans do", on the user's existing AI subscription.
...
- **"Discord bot"** - a Discord bot for agentic team conversations.
