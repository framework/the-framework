One agent's action bar: what the agent is on the left — its branch, state, and a summary of what the branch holds, as a disclosure — and what the user can do to it on the right.
