One session's view, live or finished, in a stable frame — bar, details, changes/handoff, transcript and composer — whose contents change instead of remounting when the agent ends.
