What the tests cover: the Overview's Agents card.

- It lists the agents currently working, described as such, with no split between current and finished agents.
- Clicking a row opens that agent in its project, rather than landing the user on the project's launcher.
