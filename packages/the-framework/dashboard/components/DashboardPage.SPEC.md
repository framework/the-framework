The Overview landing page, shown when no project is picked: usage first, then what needs a human, who is working now, what the AI takes up next, the routine jobs, and the hot tickets across every project — polled so it stays live.

## Flows

- Every card is a projection of the same per-project files the daemon reads. Selecting a row jumps into its project, straight into an agent, or onto a ticket's own page.
