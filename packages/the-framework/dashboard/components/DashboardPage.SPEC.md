The Overview landing page, shown when no project is picked: usage first, then what needs a human beside who is working now and what the AI takes up next, the routine jobs, and the hot tickets across every project — polled so it stays live.
