The net under the whole dashboard: a crash while drawing any view shows a recoverable "Something went wrong" card instead of the blank white screen that would otherwise take the entire app down.
