The floating menu the composer's triggers open: arrow keys move the highlight, Enter or Tab picks, the mouse works too, and items can sit under group headers.
