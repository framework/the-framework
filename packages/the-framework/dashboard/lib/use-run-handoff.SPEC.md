One shared reading of what a finished session's branch has to hand off — push, open a PR, merge — feeding both the action bar's summary and its expanded detail so the two can never disagree.

## TLDR

- Not read while the session is still running: a branch still being written to has nothing to hand off yet.
