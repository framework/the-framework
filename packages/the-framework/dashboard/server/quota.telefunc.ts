// Re-export shim (#535): the usage-panel telefunction lives in @gemstack/the-framework so the
...
import { onQuota, onAutoPm, sendAutoPmSweep } from '../../dist/dashboard-rpc/index.js'
