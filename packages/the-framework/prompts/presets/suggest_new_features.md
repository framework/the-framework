1. Study what this product does today: skim the README, the docs, and the main user-facing surfaces, plus the existing `tickets/` (on the data branch — see "The data branch")
...
3. Write each proposed feature as a new ticket under `tickets/` on the data branch, following the ticket format
