...
- Lifecycle progress: an untouched agent reads as building with no session name; the name the agent picks shows up and the latest one wins when it renames itself; signalling ready for merge flips the agent to ready.
