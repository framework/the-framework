...
- The instructions: stop the run, answer a parked gate, send a live chat message, move the end-of-session handoff, and a human's Merge — a pre-commitment that outranks the agent's own ready signal.
