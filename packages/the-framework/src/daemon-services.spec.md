...
- Drain runs carry the ticket (#1117) and the pinned queue entry (#1253) onto the run's meta — the one moment the framework knows what a run implements; suspended records carry the pin too (#1268) so the claim survives restarts.
