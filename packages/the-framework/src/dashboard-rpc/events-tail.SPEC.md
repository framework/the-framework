...
- Each logged event is handed over once, and a one-time signal marks the moment everything already logged has been delivered — the boundary a reconnecting viewer needs to swap its feed atomically instead of blanking while history re-streams.
