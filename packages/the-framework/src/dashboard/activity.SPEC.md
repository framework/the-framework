The activity feed: the cross-project stream of agent lifecycle moments — an agent started, an agent finished — that notify the user without needing anything from them.

## User Stories

- The user turns on activity notifications and is told when an agent starts and when one finishes, without watching the dashboard.
