...
- An answer can only be queued for a cloud session that has a question parked, and only with a label that question offered — any other text is refused with the reason.
