...
- It carried more for a release after the surfaces that drew them were cut: a status rollup, a two-week activity window, a per-project agent count. Each of those needed every project's whole archive listed, so the page paid a fan-out over all of it on every poll to render nothing. What a payload costs is a reason to keep it honest about who reads it.
