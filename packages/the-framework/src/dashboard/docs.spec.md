...
- `DOC_CATEGORIES` defines the two categories (PLAN, TODO/backlog) with their flat names and session-scoped regexes; the flat backlog defers to `findFlatTodo` (the #682 root `TODO_AGENTS.md`, or legacy `tickets/TODO.md` / `TODO.md`).
