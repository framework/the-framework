...
- The full question — options, recommendation, whether it needs confirming — is read back from each parked session's own log, because the run's summary record only carries the title.
