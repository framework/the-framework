...
- A driver answers only "which CLI do I spawn". Whether a run ends at its first prompt is a fact about where that prompt executed, and lives with the location instead.
