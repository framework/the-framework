...
- Watches the directory for low latency, with a polling backstop for reliability; nothing that goes wrong in either may crash the process. A tail can opt out of keeping the process alive, so steering never holds a finished agent open.
