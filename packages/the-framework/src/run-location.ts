...
export type RunLocation = 'local' | 'actions' | 'web'
...
export function isRunLocation(value: unknown): value is RunLocation {
 ...
 */
export function isHandsOff(location: RunLocation | undefined): boolean {
  return location === 'web'
}
