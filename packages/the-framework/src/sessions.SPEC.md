...
- The state directory's ignore rules are upgraded once to a glob covering every user — naming each user made every newcomer dirty a tracked file — and an ignore file hand-edited beyond recognition is left alone.
