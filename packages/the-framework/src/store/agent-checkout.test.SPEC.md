...
- An agent whose worktree is gone but whose archive exists follows the archived event log rather than the project root's — including when the archive is filed under a user directory on the data branch.
