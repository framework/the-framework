...
The Fable model cannot be selected in the dashboard's model picker (screenshot in the issue). Low priority, post-MVP.
...
Imported from GitHub issue [gemstack-land/the-framework#1143](https://github.com/gemstack-land/the-framework/issues/1143), created 2026-07-25, labels: `bug`, `priority: low`.
